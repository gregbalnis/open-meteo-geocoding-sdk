...
Modified principles:
- [PRINCIPLE_1_NAME] -> I. Code Quality (Effective Go)
- [PRINCIPLE_2_NAME] -> II. Testing Standards
- [PRINCIPLE_3_NAME] -> III. User Experience Consistency
- [PRINCIPLE_4_NAME] -> IV. Performance Requirements
- [PRINCIPLE_5_NAME] -> V. Documentation Standards
Added sections:
...
-->
# Open-Meteo Geocoding SDK Constitution
...
The output MUST be consistent and predictable. Error messages MUST be actionable and clear to the end-user, distinguishing between user errors and system failures.
...
**Rationale**: Geocoding data applications are often used in resource-constrained environments or high-frequency scenarios. Efficient resource usage ensures scalability and responsiveness.
